...
reef_species <- reef_tidy %>%
  ...
  filter(phylum==c("annelida","porifera","mollusca")) #select only the coocurring species you want to look at (BASED ON INPUT)
...
#Find average abundance values of each phylum for each location
reef_summary <- reef_tidy %>%
  ...
  filter(phylum==c("annelida","porifera","mollusca")) #select only the species you want to look at (BASED ON INPUT)
```
