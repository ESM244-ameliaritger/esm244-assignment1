...
You get to decide what variables and summary statistics to visualize. Here’s what you should prepare: A single polished HTML (knitted from .Rmd), planning that this might be a post/project you’d include on your personal blogdown site, that includes at least:
